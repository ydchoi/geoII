...
\eQb
dt = (\dfrac{1}{u} + \dfrac{u}{1-u^2}) du 
\eQe 
so 
\eQb
t &=& \ln |u| - \dfrac{1}{2} \ln|1-u^2| + C.
\eQe
and
\eQb
e^{t-C} = |u||1-u|^{-\frac{1}{2}}.
\eQe
...
\eQb
\dfrac{1}{2} |\triangle u|^2 + \frac{1}{4} (\int u^2 dx)^2 - \dfrac{1}{2} \int
u^2 dx &\leq& E(u) .
\eQe
...
&\leq& \dfrac{C(\epsilon + \epsilon^3)}{t}
\eQe
and
for $0 < s < t -1 $,
\eQb
...
&\leq& 
\int_{0}^{t-1} ||\frac{C}{(t-s)^{\frac{1}{2}}}  (u-u^3)||_{1} ds \\ 
&\leq& \int_{0}^{t-1} \dfrac{C}{t^{\frac{1}{2}}} (
||u(s)||_{2}^2 ||u(s)||_{\infty} + ||u(s)||_{\infty}) \\
&\leq& \dfrac{C(\epsilon + \epsilon^3)}{t^{\frac{1}{2}}} .
\eQe
...
||z' + l^2 z||_{L^2}^2 &=& \lambda^{\frac{7}{3}} ||v' + l^2 \lambda v||_{L^2}^2. 
\label{eq:1-2-3-1} 
\eQne
...
\eQb
C^{-1} \lambda^{\frac{2}{3}} ||v||_{L^2}^2 &\leq& ||v' + l\lambda v||_{L^2}^{2}. \\ 
\eQe
...
\eQb
\partial_t \hat{v} &=& -\xi^2 \hat{v} - 2t\xi \eta \hat{v} - t^2 \eta^2 \hat{v}
\eQe
and hence
\eQb
\hat{v} &=& \hat{u_0}(\xi, \eta) e^{-\xi^2 t - \xi \eta t^2 - \frac{1}{3} \eta^2
t^3}. 
\eQe
Therefore,it suffices to show that 
\eQb
\mathscr{F}(\Phi) &=& e^{-\xi^2 t - \xi \eta t^2 - \frac{1}{3}\eta^2 t^3}.
\eQe
...
\eQb
u(t,x,z) = \int \dfrac{C_0}{t^2} e^{-\frac{(x-z_1)^2}{t} + \frac{3(x-z_1)(z+xt - z_2)}
{t^2} - \frac{3(z+xt-z_2)^2}{t^3}} u_0(z_1, z_2) dz_1 dz_2.
\eQe
...
\eQb
||\Phi(t,x,xt+z)||_r^r &=& \int \dfrac{C_0^r}{t^{2r}} e^{r(-\frac{x^2}{t} + 
\frac{3x(xt+z)}{t^2} - \frac{3(xt+z)^2}{t^3})} dx dz \\
